      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              src="https://thumbs.dreamstime.com/b/yellow-tooth-symbolizing-modern-dental-health-care-bright-icon-white-background-hygiene-396170648.jpg"
              width="50"
              height="50"
              alt="DentAssist"
              style={logo}
            />
            <Text style={logoText}>DentAssist</Text>
          </Section>
          ...
          <Text style={footerText}>
            If you have any questions, please contact us at support@dentAssist.com
          </Text>
        </Container>
      </Body>
    </Html>
